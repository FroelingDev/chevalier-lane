...
export function AirportBooking() {
  ...
  }, [formData.pickupLocation, formData.dropoffLocation, selectedCar, formData.extraVehicle])
  ...
  const calculateTripDetails = async () => {
    ...
    try {
      ...
      if (calculatedDistance) {
        ...
        const price = calculatePrice(calculatedDistance, selectedCar, formData.extraVehicle)
  ...
  const validateForm = (): string[] => {
    ...
    if (!formData.dropoffLocation.trim()) errors.push('Drop-off location is required')
          ...
          <form onSubmit={handleSubmit} className="space-y-12">
            ...
            <div className="bg-white rounded-lg shadow-luxury p-8 border border-luxury-gold/10">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-2xl luxury-heading text-luxury-black">Flight Information</h2>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-luxury p-8 border border-luxury-gold/10">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-2xl luxury-heading text-luxury-black">Transfer Details</h2>
              </div>
                ...
                {selectedCar?.category === 'modern' && (
                  <div className="flex items-center">
                    <input
                      ...
                      onChange={(e) => handleInputChange('extraVehicle', e.target.checked)}
                ...
                {selectedCar?.category === 'classic' && (
                  <div className="bg-amber-50 p-4 rounded-md border border-amber-200">
                    <p className="text-sm text-amber-800">
                      <strong>Note:</strong> Classic car transfers include an extra vehicle (Range Rover Vogue) for luggage at €{selectedCar.extraVehiclePrice} extra.
                    </p>
                  </div>
                )}
              </div>
            ...
            {(isCalculating || hasCalculated) && (
              <div className="bg-luxury-gold/5 rounded-lg p-6 border border-luxury-gold/20">
                <h3 className="text-lg font-semibold text-luxury-black mb-3">Transfer Summary</h3>
                {isCalculating ? (
                  ...
                  <div className="grid md:grid-cols-4 gap-4">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="text-gray-700">
                        Extra Vehicle: <span className="font-semibold text-luxury-black">
                          {formData.extraVehicle || selectedCar?.category === 'classic' ? 'Yes' : 'No'}
                        </span>
                      </span>
                    </div>
                  </div>
            ...
            <div className="text-center">
              ...
              {selectedCar && (!formData.pickupLocation || !formData.dropoffLocation) && (
                <p className="text-red-600 mt-2 text-sm">
