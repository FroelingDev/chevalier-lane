      ...
      >
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="scroll-fade-in">
            <div
              className={`grid lg:grid-cols-2 gap-16 items-center ${imageOnLeft ? "" : "lg:grid-flow-col-dense"}`}
            >
              <div
                className={`space-y-8 ${imageOnLeft ? "order-2 lg:order-1" : "order-2 lg:order-2"}`}
              >
                <div>
              ...
              <div
                className={`relative ${imageOnLeft ? "order-1 lg:order-2" : "order-1 lg:order-1"}`}
              >
                <img
                  src={mainImage}
                  alt={mainImageAlt}
