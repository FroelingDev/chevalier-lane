    ...
    <header className="relative z-30 p-6 bg-gradient-to-br from-luxury-ivory via-luxury-pearl to-luxury-white text-luxury-black border-b border-luxury-gold/20 shadow-luxury-soft overflow-visible">
      ...
      <div className="flex justify-between items-center max-w-7xl mx-auto relative z-10">
        <div className="luxury-heading text-2xl md:text-3xl tracking-wider">
          <Link
            to="/"
            className="text-luxury-black font-medium hover:text-luxury-gold transition-all duration-500 relative group"
          >
            Chevalier Lane
                  ...
                  <ul className="grid gap-3 p-4 w-[350px] md:w-[500px] md:grid-cols-2 lg:w-[600px]">
                    ...
                    <li>
                      <NavigationMenuLink asChild>
                        ...
                        >
                          <div className="text-sm font-medium leading-none font-playfair">
                            Airport Transfers
                          </div>
          ...
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            <SheetTrigger asChild>
              <Button
                variant="ghost"
                size="icon"
                className="h-10 w-10 bg-gradient-to-r from-luxury-ivory to-luxury-pearl border border-luxury-gold/20 hover:border-luxury-gold/40 hover:bg-gradient-to-r hover:from-luxury-gold/5 hover:to-luxury-champagne/5 transition-all duration-500 shadow-luxury-soft hover:shadow-luxury"
              >
            ...
            <SheetContent
              side="right"
              className="w-[300px] sm:w-[400px] flex flex-col bg-gradient-to-br from-luxury-ivory via-luxury-pearl to-luxury-white border-l border-luxury-gold/20"
            >
              <SheetHeader className="flex-shrink-0 pb-6 border-b border-luxury-gold/10">
                <SheetTitle>
                  <Link
                    to="/"
                    className="luxury-heading text-2xl tracking-wider text-luxury-black hover:text-luxury-gold transition-colors duration-300"
              ...
              <nav className="flex-1 overflow-y-auto pr-1 pb-6 pl-4">
                ...
                <div className="space-y-3 mt-4">
                  <h3 className="luxury-sans-medium text-sm uppercase tracking-wider text-luxury-black/70 mb-3 border-b border-luxury-gold/20 pb-2">
                    Services
                  </h3>
                  <div className="pl-2 space-y-1">
                    <Link
                      to="/services"
                      className="block py-2.5 text-sm text-luxury-black hover:text-luxury-gold transition-all duration-300 hover:translate-x-1 font-playfair"
                      onClick={() => setIsOpen(false)}
                    >
                      Our Services
                    </Link>
                    <Link
                      to="/services/airports"
                      className="block py-2.5 text-sm text-luxury-black/80 hover:text-luxury-gold transition-all duration-300 hover:translate-x-1"
                      onClick={() => setIsOpen(false)}
                    >
                      Airport Transfers
                    </Link>
                ...
                <div className="space-y-2 pt-6 mt-8 border-t border-luxury-gold/20">
                  <Link
                    to="/about"
                    className="block py-3 text-sm luxury-sans-medium text-luxury-black hover:text-luxury-gold transition-all duration-300 hover:translate-x-1 font-playfair"
                    onClick={() => setIsOpen(false)}
                  >
                    About
                  </Link>
